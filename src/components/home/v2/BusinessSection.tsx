...
function BusinessLeadCard({ article }: { article: ArticleWithRelations }) {
  return (
...
function BusinessListItem({
  ...
  return (
    <li className="group flex items-start gap-3 border-b border-gray-100 py-2.5 last:border-0">
      ...
      <h4 className="line-clamp-2 text-[13px] font-semibold leading-snug text-gray-900 transition-colors duration-150 group-hover:text-blue-700">
...
export function BusinessSection({ articles }: Props) {
