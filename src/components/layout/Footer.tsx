        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/editorial-policy" className="text-white/70 hover:text-white">Editorial Policy</Link></li>
              <li><Link href="/corrections" className="text-white/70 hover:text-white">Corrections</Link></li>
